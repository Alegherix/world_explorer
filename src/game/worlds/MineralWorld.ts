...
class MineralWorld extends Game {
  ...
  private defaultConfigSolid: MeshStandardMaterialParameters;
  ...
  constructor(
    ...
    this.bouncePadConfig = get(LoaderStore).loader.getMineralWorldBouncePad();
    this.defaultConfigSolid = get(LoaderStore).loader.getMineralWorldConfig();
    this.defaultConfig = get(LoaderStore).loader.getMineralWorldPlaneConfig();
